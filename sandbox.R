...
res_ag <- opt_prob_lim(`Артериальная гипертензия` ~
                         #  `Пол`
                         `Вы работаете?`
                       + `Сахарный диабет`
...
res_st <- opt_prob_lim(`Стенокардия, ИБС, инфаркт миокарда` ~ 
                      `Вы работаете?`
                    # + Пол
                    # + `Выход на пенсию`
                    + `Регулярный прим лекарственных средств`
...
res_sn <- opt_prob_lim(`Сердечная недостаточность` ~ 
                      #  `Вы работаете?`
                      # + Пол
                      `Регулярный прим лекарственных средств`
                    + `Выход на пенсию`
                    ...
                    # + `Сигарет в день`
                    ,
                    predict_glm, "Сердечная недостаточность")
...
res_another <- opt_prob_lim(`Прочие заболевания сердца` ~ 
                              `Регулярный прим лекарственных средств`
